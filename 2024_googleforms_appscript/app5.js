function populateFormWithSections() {
    try {
      ...
      var jsonData = [
        ...
        {
          "sectionTitle": "SQL Functions - 🟨 Yellow",
          "questions": [
            {
        ...
        {
          "sectionTitle": "SQL Data Types - 🟢 Green",
          "questions": [
            {
        ...
        {
          "sectionTitle": "Advanced SQL - 🔵 Blue",
          "questions": [
            {
      ...
      // Add a page break before the first section to ensure form structure
      form.addPageBreakItem();
  
      // Loop through the JSON data and create sections and questions
      jsonData.forEach(function(section, sectionIndex) {
        try {
          // Add a new section header with simulated color cues
          ...
          // Add a page break after each section to simulate tab-like navigation
          if (sectionIndex < jsonData.length - 1) {
            form.addPageBreakItem(); 
          }
